    ...
    triggers: [
        ...
        {//完成
            ...
            run: (data, matches, output) => {
                if (matches.id == '777A') data.boss = '绿';
                if (matches.id == '777B') data.boss = '白';
                if (matches.id == '777C') data.boss = '黄';
